...
Config.instname = "Universidad Politécnica de Madrid"
Config.profilename = "eduroam.upm"
Config.url = "http://www.upm.es/wifi"
Config.email = "red.rectorado@upm.es"
Config.title = "eduroam CAT"
Config.server_match = "rds.upm.es"
...
Config.user_realm = "upm.es"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:rds.upm.es']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@upm.es"
Config.tou = ""
